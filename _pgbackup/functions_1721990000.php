...
if ( ! function_exists( 'mage_hd_theme_enqueue_scripts' ) ) :
    ...
    wp_add_inline_script( 'inline-script-1', '$(\'.mobile-content.speed-content\').hide();
    ...
    wp_add_inline_script( 'inline-script-2', 'document.getElementById(\'page-speed-form\').addEventListener(\'submit\', function (event) {

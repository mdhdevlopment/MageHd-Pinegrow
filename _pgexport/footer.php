            ...
            <div class="max-w-[90vw] mx-auto  w-full lg:container"> 
                <div class="footer-news-letters py-120">
                    ...
                    <?php if( !$mailer->processed || $mailer->error) : ?>
                        <form class="subscribe-form" id="subscribe-form_mailer_id" action="<?php echo '#subscribe-form_mailer_id'; ?>" method="post" onsubmit="event.stopImmediatePropagation();event.stopPropagation();">
                            ...
                            <button class="subscribe-btn"><i class="fa fa-long-arrow-right"></i>
                            </button>
                ...
                <div class="footer-menus">
                    <div class="footer-logo pb-60">
                        <a class="logo" href="<?php echo esc_url( home_url() ); ?>"> <?php if( get_theme_mod( 'custom_logo' ) ) : ?><img src="<?php echo PG_Image::getUrl( get_theme_mod( 'custom_logo', esc_url( get_template_directory_uri() . '/assets/images/logo.png' ) ), 'full' ) ?>" class="h-14 object-cover"><?php endif; ?> </a>
                    </div>
                ...
                <div class="bottom-footer-logos flex justify-center gap-5  ">
                    <img alt="logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/footer-clucth-florida.svg"/> 
                    <img alt="logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/footer-clucth-us.svg"/> 
                    <img alt="logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/BBB-footer.svg"/> 
                    <img alt="logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/footer-clucth-tampa.svg"/> 
                    <img alt="logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/footer-clucth-black-owned.svg"/> 
                </div>
                <div class="footer-copyright flex justify-between">
                    ...
                    <div class="footer-social-list social-list flex gap-5"> <a href="<?php echo get_theme_mod( 'facebook', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/facebook.svg" alt="" class="social-icon"></a><a href="<?php echo get_theme_mod( 'twitter', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/twitter.svg" alt="" class="social-icon"></a><a href="<?php echo get_theme_mod( 'linkedin', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/linkedin.svg" alt="" class="social-icon"></a><a href="<?php echo get_theme_mod( 'instagram', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/instagram.svg" alt="" class="social-icon"></a>
                    </div>                     

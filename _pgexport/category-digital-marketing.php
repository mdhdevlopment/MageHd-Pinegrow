...
<section class="hero-banner py-120 relative"> 
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/banner-eclipse-large.svg" class="cirle-left"> 
</section>     
        ...
        <div class="blog-content-wrap flex flex-wrap justify-between gap-5">
            <?php
                $service_query_args = array(
                    ...
                    'order' => 'ASC',
                    'orderby' => 'date',
                    'tax_query' => array_filter( array(PG_Helper_v2::getTaxonomyQuery( 'category', 'digital-marketing' )) )
                )
            ?>

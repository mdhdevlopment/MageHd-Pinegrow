...
<section class="hero-banner" style="position: relative; padding: 60px 0;"> 
    <div class="max-w-[90vw] mx-auto  w-full lg:container"> 
        <div class="flex flex-col"> 
            ...
            <div class="hero-content mb-5" style="font-family: 'Questrial', sans-serif; font-size: 26px; font-weight: 500; padding-top: 60px;  line-height: 36px; color: #F2F2F2;">
...
<section class="blog-content py-120 border-y border-#F2F2F2">
    <div class="max-w-[90vw] mx-auto  w-full lg:container"> 
        <div class="flex flex-col gap-10"> 
            ...
            <div class="single-post-social-list flex justify-center gap-4"> <a href="<?php echo get_theme_mod( 'facebook', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/facebook.svg" alt="" class="social-icon"></a><a href="<?php echo get_theme_mod( 'twitter', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/twitter.svg" alt="" class="social-icon"></a><a href="<?php echo get_theme_mod( 'linkedin', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/linkedin.svg" alt="" class="social-icon"></a><a href="<?php echo get_theme_mod( 'instagram', '#' ); ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/instagram.svg" alt="" class="social-icon"></a>
            </div>                 
        </div>
    </div>
</section>     
